...
## Docs & Tradeoffs
 ...
 - Check out and add example code [snippets](https://github.com/amark/gun/wiki/snippets-(v0.3.x)) âincluding micro-modulesâ to address specific situations.
...
Designed with â¥ by Mark Nadal, the gun team, and many amazing contributors.  Liberally licensed under [Zlib / MIT / Apache 2.0](https://github.com/amark/gun/blob/master/LICENSE.md).
